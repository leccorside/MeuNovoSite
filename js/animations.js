...
const progressText = preloader ? preloader.querySelector('strong') : null;
const progressBar = preloader ? preloader.querySelector('.loader-line span') : null;

if (preloader && progressText && progressBar) {
  if (reduceMotion) {
